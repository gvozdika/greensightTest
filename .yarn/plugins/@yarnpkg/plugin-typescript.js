            ...
            /******/ [
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    exports.hasDefinitelyTyped = async (descriptor, configuration) => {
                        ...
                        try {
                            ...
                            return (
                                ((_a = packageInfo.types) === null || _a === void 0 ? void 0 : _a.ts) ===
                                'definitely-typed'
                            );
                        } catch (_e) {
                            return false;
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    const createSearchClient = options => {
                        const appId = options.appId;
                        const auth = clientCommon.createAuth(
                            options.authMode !== undefined ? options.authMode : clientCommon.AuthMode.WithinHeaders,
                            appId,
                            options.apiKey
                        );
                        const transporter$1 = transporter.createTransporter({
                    ...
                    const replaceAllObjects = base => {
                        return (objects, requestOptions) => {
                            const { safe, autoGenerateObjectIDIfNotExist, batchSize, ...options } =
                                requestOptions || {};
