...
<Meta title="Standart / CheckboxGroup" component={CheckboxGroup} decorators={[centeredDecorator]} />
...
<Story name="Controls" args={{ label: 'Выберите вариант', hint: 'Подсказка' }}>
    {args => (
...
<ArgsTable of={CheckboxGroup} story="Controls" />
